...
const Stats = () => {
  return (
    <div>
      <div>
        <h1 className="mt-20 text-center text-3xl lg:mt-20 lg:text-5xl font-bold">
          Advanced Statistics
        </h1>
        <p className="text-center mx-2 mt-2 mb-12 lg:hidden text-gray-400">
          Track how your links are performing <br /> across the web with our
          advanced <br /> statistics dashboard.
        </p>
        <p className="hidden lg:block text-center mx-2 mt-4 mb-12 text-gray-400">
      ...
      <div className="lg:flex justify-center mb-20">
        <div className="absolute m-auto left-[40%] ">
          <div className="bgNav flex justify-center rounded-full lg:ml-[-340px] mt-[-45px] lg:mt-[5px] w-20 h-20 ">
            <svg
              className="mt-3 "
        ...
        <div className="bg-white max-w-[900px] rounded-lg mx-4 mt-20 lg:mt-12 mb-8 lg:h-[255px]">
          <h1 className="text-center text-2xl font-bold pt-16 mx-5">
            Brand Recognition
          </h1>
          <p className="text-center pb-8  mt-2 text-gray-400">
            Boost your brand recognition with <br /> each click. Generic links
            don't <br /> mean a thing. Branded links help <br /> instil
            confidence in your content.
          </p>
        </div>
        <div className="flex justify-center sm:hidden">
          <div className="bg-cyan-300 h-10 mt-[-31px] w-2"></div>
        </div>
        <div className="absolute m-auto left-[40%] ">
          <div className="bgNav flex justify-center lg:ml-[20px] lg:mt-8  rounded-full w-20 h-20">
            <svg
              className="mt-[20px]"
              xmlns="http://www.w3.org/2000/svg"
              width="40"
        ...
        <div className="bg-white max-w-[900px] rounded-lg mb-8 mx-4 mt-12 lg:mt-20 lg:h-[255px]">
          <h1 className="text-center text-2xl font-bold pt-16 mx-5">
            Detailed Records
          </h1>
          <p className="text-center pb-8  mt-2 text-gray-400">
            Gain insights into who is clicking <br /> your links. Knowing when
            and <br /> where people engage with your <br /> content helps inform
            better <br /> decisions.
          </p>
        </div>
        <div className="absolute m-auto left-[40%] lg:pt-[60px]">
          <div className="bgNav flex justify-center  lg:ml-[370px] rounded-full mt-1  w-20 h-20">
            <svg
              className="mt-3"
              xmlns="http://www.w3.org/2000/svg"
              width="48"
        ...
        <div className="bg-white max-w-[900px] rounded-lg mb-8 mx-4 mt-12 lg:mt-28 lg:h-[255px]">
          <h1 className="text-center text-2xl font-bold pt-16 mx-5">
            Fully Customizable
          </h1>
          <p className="text-center pb-8  mt-2 text-gray-400">
            Improve brand awareness and <br /> content discoverability through{" "}
            <br /> customizable links, supercharging <br /> audience engagement.
          </p>
        </div>
      </div>
    </div>
