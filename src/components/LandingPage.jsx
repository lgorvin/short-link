...
const LandingPage = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2">
      <div className="hidden lg:mt-28 lg:block lg:ml-0 xl:ml-36">
        <h1 className="text-left font-bold text-7xl ml-16  mt-[-30px]">
          More than just shorter links
        </h1>
        <p className="text-left text-xl  mt-2 ml-16 text-gray-400">
          Build your brand's recognition and get detailed <br /> insights on how
          your links are performing.
        </p>
        <div className="ml-16">
          <button className="btnBlue px-[30px] mt-4 lg:px-[30px] py-[10px] text-white font-bold shadow-lg hover:brightness-90 duration-300 lg:mr-1 rounded-3xl">
            Get Started
          </button>
        </div>
      </div>
      <div className="ml-[-78px] lg:ml-[110px] lg:mr-32">
        <svg
          className="scale-75 lg:scale-100 block m-auto "
      ...
      <div className="lg:hidden">
        <h1 className="text-center font-bold text-4xl mx-10 mt-[-30px]">
          More than just shorter links
        </h1>
        <p className="text-center mx-2 mt-2 text-gray-400">
          Build your brand's recognition and <br /> get detailed insights on how
          your links <br /> are performing.
        </p>
