...
export default function Footer() {
  return (
    <div>
      <div className="bgNav h-64">
        <h1 className="text-center text-white font-bold text-2xl lg:text-5xl pt-20">
          Boost your links today
        </h1>
        <div className="flex justify-center mt-4">
          <button className="btnBlue text-white font-bold px-[40px] lg:px-[80px] py-[10px] lg:py-[16px] shadow-lg hover:brightness-90 duration-300 lg:mr-1 rounded-3xl">
            Get Started
          </button>
        </div>
      </div>
      <MDBFooter className="text-center bgFooter text-lg-start text-muted">
